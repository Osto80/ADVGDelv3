...
import stylesCss from 'themes/ad-theme/styles.css?inline';
import { color } from '@vaadin/vaadin-lumo-styles';
import { typography } from '@vaadin/vaadin-lumo-styles';
import vaadinNavbarLayoutCss from 'themes/ad-theme/components/vaadin-navbar-layout.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_ad-theme_componentCss']) {
    registerStyles(
      'vaadin-navbar-layout',
      unsafeCSS(vaadinNavbarLayoutCss.toString())
    );
    
    document['_vaadintheme_ad-theme_componentCss'] = true;
  }
